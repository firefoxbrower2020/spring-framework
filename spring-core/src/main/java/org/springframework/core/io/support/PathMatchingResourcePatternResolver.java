 ...
 *
 * org.springframework.core.io.support.PathMatchingResourcePatternResolver，为ResourcePatternResolver最常用的子类，
 * 它除了支持ResourceLoader和ResourcePatternResolver新增的“classpath*:*”前缀外，
 * 还支持Ant风格的路径匹配模式（类似于 "**\/*.xml"）反斜杠是转义，不加报错
 */
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	public Resource[] getResources(String locationPattern) throws IOException {
		...
		// 不以“classpath*:”开头
			...
			// and on Tomcat only after the "*/" separator for its "war:" protocol. 而在Tomcat上只有在“*/”分隔符之后才为其“war:”协议
	...
	protected String determineRootDir(String location) {
		...
		// 在从冒号开始到最后的字符串中，循环判断是否包含通配符，如果包含，则阶段最后一个由“/”分割的部分

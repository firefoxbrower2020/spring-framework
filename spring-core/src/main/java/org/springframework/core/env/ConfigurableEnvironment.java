...
public interface ConfigurableEnvironment extends Environment, ConfigurablePropertyResolver {
	...
	/**
	 * 尝试返回System.getProperties()的值，若失败则返回通过System.getProperty(String)访问各个键得到的映射
	 *
	...
	/**
	 * 尝试返回System.getenv()的值，若失败则返回通过System.getenv(String)访问各个键得到的映射
	 *
